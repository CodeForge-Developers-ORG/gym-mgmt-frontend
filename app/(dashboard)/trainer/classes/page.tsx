...
export default function TrainerClassesPage() {
  ...
  const columns: Column<any>[] = [
    ...
    { header: "", cell: () => <Button variant="ghost" size="sm">Manage Roster</Button> },
  ]
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <SlideInText text="My Classes" />
          <p className="text-muted-foreground">View and manage your assigned classes and rosters.</p>
        </div>
      </div>
      <DataTable data={classes} columns={columns} searchPlaceholder="Search my classes..." />
    </div>
  )
}
